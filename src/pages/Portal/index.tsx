...
const PortalPage: React.FC = () => {
    ...
    // Calculate Vacation Balance & Pending
    if (profileRes.data?.company_entry_date) {
        ...
        setVacationBalance(summary.currentRemaining); // Available (after pending subtraction)
        setVacationPending(summary.future); // Pending days
    }
    ...
    const approvedPerms = permReqs
        ...
        .reduce((sum, r: any) => sum + r.days_requested, 0) || 0;
