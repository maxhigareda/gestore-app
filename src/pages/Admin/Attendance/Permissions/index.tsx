...
const PermissionsPage: React.FC = () => {
    ...
    const permissionRequests = requests.filter(r => r.type !== 'vacation');
    ...
    // Tabs Logic
    const approvedRequests = permissionRequests.filter(r => r.status === 'Aprobada');
    const pendingRequests = permissionRequests.filter(r => r.status === 'Solicitada');
    const rejectedRequests = permissionRequests.filter(r => r.status === 'Rechazada');
