            ...
            <div style={{ marginBottom: '0.5rem' }}>
                ...
                {openMenus['collaborators'] && (
                    <div style={{ paddingLeft: '1rem', display: 'flex', flexDirection: 'column', gap: '2px' }}>
                        ...
                        <SubMenuLink label="Estatus de Usuarios" onClick={() => navigate('/admin/collaborators/status')} />
                    </div>
                )}
            </div>
            ...
            <div style={{ marginBottom: '0.5rem' }}>
                ...
                {openMenus['attendance'] && (
                    <div style={{ paddingLeft: '1rem', display: 'flex', flexDirection: 'column', gap: '2px' }}>
                        ...
                        <SubMenuLink label="Permisos" onClick={() => navigate('/admin/attendance/permissions')} />
    ...
    return (
        <aside style={{
            ...
            <div style={{
                ...
                {/* Placeholder Logo */}
                <img src="/assets/logo_talent_flow.png" alt="TalentFlow" style={{ height: '28px', maxWidth: '100%', objectFit: 'contain' }} />
            </div>
